...
const SchedulePage = () => {
    ...
    const day2Arr = [
        ...
        {
            Img:true,
            eventName: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repellendus dolores quis minus molestiae adipisci iure sit laboriosam assumenda sapiente aperiam. Dolor aperiam illo deserunt a nam possimus laboriosam repellat cumque.",
            speaker:"Dr XYZ ABC",
            img:sample,
            color:"yellow",
            time:"04:30PM",
    ...
    return (
        <div className="schedulePage h-full font-inter mt-10">
            <div className="schedulePageHead 
                            h-36 
                            bg-neutral-100
                            flex 
                            items-center
                            ...
                            border-zinc-950
            ">
                <Image src={logo} className="schedulePageHeadLogo
                                            md:h-[45%]
                                            h-[45%]
                                            ml-16
                                            md:ml-28
                "/>
                <div className="schedulePageHeadText
                                pl-4
                ">
            ...
            ">
                ...
                ">
                    <div className={`btn1
                                    ...
                                    ${tabNo==0?"text-white bg-black ":'hover:bg-orange-200'}
                    ...
                    <div className={`btn2
                                    ...
                                    flex-col
                                    md:gap-2
                                    ${tabNo==1?"text-white bg-black ":'hover:bg-orange-200'}
                    ...
                    <div className={`btn3
                                    ...
                                    flex-col
                                    md:gap-2
                                    ${tabNo==2?"text-white bg-black ":'hover:bg-orange-200'}
